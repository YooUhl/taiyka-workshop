...
export const FREE_N8N_PACK_COPY: Record<"fr" | "en", FreeN8nPackCopy> = {
  fr: {
    ...
    subHero:
      "Pas de théorie. Pas de \"10 idées pour utiliser l'IA\". Juste 5 workflows prêts à importer dans ton n8n — ça tourne en 30 minutes.",
    ...
    bullets: [
      ...
      "Un système de veille Instagram concurrentiel (le bonus avancé)",
    ],
    formKicker: "RÉCUPÉRER LE PACK",
    formIntro: "Entre ton email. Le ZIP arrive en moins de 2 minutes.",
    reassurance: "ZIP dans 2 min max. Zéro spam.",
    ...
    upsellPrimary: "Voir mes packs de workflows →",
    upsellPrimaryHref: "/shop",
    upsellSecondary: "Ou découvre la communauté Skool (ouverture bientôt) →",
  ...
  en: {
    ...
    subHero:
      "No theory. No \"10 ways to use AI\". Just 5 workflows ready to import into your n8n — running in 30 minutes.",
    ...
    upsellPrimary: "See my workflow packs →",
    upsellPrimaryHref: "/shop?lang=en",
    upsellSecondary: "Or check out the Skool community (opening soon) →",
